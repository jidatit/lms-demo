...
function Categories({ categories, handelFilter, filter }) {
        ...
        <>
          ...
          <Box sx={{ pl: 0.5 }}>
            <Stack>
              {/* "All" option */}
              <FormControlLabel
                control={<Checkbox checked={filter.categories.includes('all')} onChange={() => handelFilter('categories', 'all')} />}
                label="All"
              />
              ...
              {categories.map((category) => (
                <FormControlLabel
                  key={category}
                  control={
                    <Checkbox checked={filter.categories.includes(category)} onChange={() => handelFilter('categories', category)} />
                  }
                  label={category}
                />
              ))}
...
const ProductFilter = ({ filter, handelFilter, categories }) => (
  <Grid container direction="column" rowSpacing={3}>
    <Grid item>
      <Categories filter={filter} categories={categories} handelFilter={handelFilter} />
    </Grid>
  </Grid>
);

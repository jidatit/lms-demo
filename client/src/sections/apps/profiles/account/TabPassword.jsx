      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          password: Yup.string()
            ...
            .test('password-strength', 'Password must contain at least 8 characters, one uppercase, one number, and one special character', (value) => {
              return minLength(value) && isLowercaseChar(value) && isUppercaseChar(value) && isNumber(value) && isSpecialChar(value);
            }),
          confirm: Yup.string()

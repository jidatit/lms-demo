...
const SideNav = () => {
  const menus = [
    ...
    {
      name: "Help",
      link: "/subscriber_dashboard/knwoledge",
      icon: <IoMdFootball />,
    },
  ];
  ...
  return (
    ...
    //           to={menu?.link}
    //           key={i}
    //           className={`group flex items-center text-base gap-2 font-poppins py-2 pl-2 pr-4 ${
    //             location.pathname === menu?.link
    //               ? "bg-[rgba(112,127,221,0.1) text-[#ffffff] bg-[#23436d] rounded-md"
    //               : "text-black"
    //           } hover:bg-[rgba(112,127,221,0.1)] hover:text-black rounded-md`}
    //         >
    //           <h2
    //             style={{

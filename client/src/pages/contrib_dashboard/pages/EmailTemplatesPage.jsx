...
import { useCreateOrUpdateCustomInvoiceTemplate, useInvoiceTemplates, useUpdateEmailTemplate } from 'api/queries/InvoiceEmailTemplates';
...
const EmailTemplatesPage = () => {
  ...
  // const { data: templatesData, isLoading: templatesLoading, error: templatesError } = useGetEmailTemplateById(currentUser?.id);
  const {
    data: templatesData,
  ...
  const updateTemplateMutation = useCreateOrUpdateCustomInvoiceTemplate();
                ...
                {templatesLoading ? (
                  ...
                  templates.map((template) => (
                    <TableRow key={template.id} hover>
                      <TableCell>
                        {template.name}
                        {template.createdBy !== currentUser?.id ? ' (Default)' : null}
                      </TableCell>

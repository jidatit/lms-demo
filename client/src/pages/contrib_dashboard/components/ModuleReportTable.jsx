...
const ModuleReportTable = ({ SelectedGroupName, viewemail }) => {
  const { currentUser } = useAuth();
  let email; // Declare the email variable outside

  if (viewemail && viewemail.viewemail) {
    email = viewemail.viewemail; // Assign viewemail if it exists and has the property
  } else {
            ...
            <div className="w-full px-2">
              ...
              <div className="w-full flex justify-center sm:justify-between xl:flex-row flex-col gap-10 mt-12 lg:mt-8 px-0 lg:px-4 xl:px-4 items-center">
                <div className="text-base text-center">
                  Showing
                  <span className="font-bold bg-[#e1ecf0]  text-[#23436d]  mx-2 p-2 text-center !rounded-lg min-w-[40px]  inline-block">

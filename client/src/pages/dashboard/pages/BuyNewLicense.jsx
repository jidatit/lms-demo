...
import { Alert, Box, Button, Chip, CircularProgress, Grid, Tab, Tabs, Typography } from '@mui/material'; // Assuming you're using MUI
      ...
      filteredBundlesData.map((product, index) => (
        <Grid key={index} item xs={12} sm={6} md={4}>
          <ProductCard
            ...
            to={`/dashboard/view_bundles?id=${product.id}&admin=true`}
            CartRoute={`/dashboard/mybundlecart?bundleId=${product.id}`}
